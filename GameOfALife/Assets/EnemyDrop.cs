...
public class EnemyDrop : MonoBehaviour
{
    ...
    void Reset()
    {
        ...
        transform.position = new Vector3(startPos.x+Random.Range(-6f, 6f), startPos.y, startPos.z);
        transform.rotation = Quaternion.Euler(startRot.x, startRot.y, (int)Random.Range(-60f, 60f));
